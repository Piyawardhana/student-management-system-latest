package com.studentManagementSystem.common.dto;
 ...
 * If you are doing use this approch, only do a "shallow" mapping and strictly avoid mapping nested entities.
 */
public interface ModelMapper<T> {
    ...
    /**
     * Warning! Only map shallowly. Any nested mappings should be handles at the business logic level not inside a DTO.
